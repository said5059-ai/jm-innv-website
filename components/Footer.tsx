    ...
    <footer className="relative overflow-hidden bg-[#07111f] text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-14 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-4">
              <div className="relative flex h-[68px] w-[68px] items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white shadow-[0_15px_40px_rgba(0,0,0,0.18)]">
                <Image
                  src="/icon.png"
                  alt="JM INNV"
                  width={54}
            ...
            <div className="mt-8 flex items-center gap-4">
              <Link
                ...
                target="_blank"
                className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition hover:border-[#08a982]/40 hover:bg-[#08a982]"
              >
                <TelegramIcon />
              </Link>
              ...
              <Link
                href="/contact"
                className="rounded-full bg-[#08a982] px-7 py-4 text-sm font-black text-white shadow-[0_16px_40px_rgba(8,169,130,0.28)] transition hover:-translate-y-1 hover:bg-[#079774]"
              >
                Связаться с нами
              </Link>
            </div>
          ...
          <div>
            ...
            <ul className="mt-7 space-y-4 text-sm text-white/60">
              <li>
          ...
          <div>
            ...
            <ul className="mt-7 space-y-5 text-sm text-white/60">
              ...
              <li className="text-lg font-black text-white">
                +998 93 136 19 20
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-white/10 pt-8 text-sm text-white/40 md:flex-row md:items-center md:justify-between">
          <p>
            © {new Date().getFullYear()} JM INNV. Все права защищены.
          </p>

          <p>
            Enterprise IT Solutions • CRM • Automation • Web Development
          </p>
        </div>
      </div>
    </footer>
